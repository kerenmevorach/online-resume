...
let colors = ['#1400FF','#F15623', '#F7D6FA', '#BC2739', '#09AF00', '#943FE8', '#00DAA2','#FF1493', '#4EEDFF', '#ff3f93']
...
circleButton.onclick= function () {
    circleButton.classList.add('circle-click')
    ...
    if (randomColor == '#4EEDFF') {
        aboutText.style.mixBlendMode = 'darken';
    }
